...
//                myShelter.playWithAPet(petName);
                ...
                if (petName.equals("Henry")) {
                    System.out.println();
                    myShelter.playWithAPet("Henry");
                } else if (petName.equals("Huey")) {
                    myShelter.playWithAPet("Huey");
                } else if (petName.equals("Hugh")) {
                    myShelter.playWithAPet("Hugh");
                } else if (petName.equals("Halle")) {
                    myShelter.playWithAPet("Halle");
                }

            } else if (userChoice.equals("4")) {
                System.out.println("You'd like to adopt a pet, please choose one:\n");
                ...
                System.out.println("Successfully adopted: " + petToAdopt);
